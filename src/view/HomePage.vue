    ...
    <div id="HomePage">
        ...
        <div id="bigData" class="container-fuild">
            <div class="row bigData-container">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <h2 class="fire-safety-title">
                        智能消防数据平台
                        <small>/ Smart Fire Safety Data Platform</small>
                    </h2>
                    <p>我们的智能消防数据平台是一款用户友好的自助工具，适用于各类用户，无论是普通居民还是专业的消防安全从业者。借助这一平台，您可以轻松设计出符合专业标准的消防安全系统。不论您需要创建简单的单页站点，还是专业的公司安全页面，都能得心应手。</p>
                    <p>采用流线式网页布局设计和可视化图文内容编辑，使得建设和维护消防系统变得轻松愉悦。无论您的背景是普通用户还是专业人士，都能充分发挥这一平台的便利。</p>
                    <h2 class="fire-safety-device">欢迎您的监督与支持！</h2>
                    <br>
        ...
        <div id="contactUs" class="container-fuild text-center">
            <div class="container contactUs-container wow slideInUp">
                ...
                <button class="btn btn-default btn-sm" onmouseleave="this.style.borderColor='#ffffff'; this.style.backgroundColor='#ffffff'; this.style.color='#3f3f3f';"
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-3 server-wrapper" v-for="(item,index) in serverList" :key="index">
                        <div class="server-block wow slideInUp" onmouseenter="this.style.color='#28f';this.style.borderColor='#28f'" onmouseleave="this.style.color='#666';this.style.borderColor='#ccc'">
                            <img class="center-block" :src="item.logo" alt="logo">
            ...
            swiperList: [
                {
                    ...
                    path: "",
                    title: '您身边的消防科技',
                    content: '我们的使命是通过创新和卓越的服务，为社会创造更安全的生活环境。',
                },
                {
            ...
            customerList: [
                {
                    ...
                    title:
                        "虚拟合作商，合作商留言，项目记录虚拟合作商，合作商留言，项目记录虚拟合作商，合作商留言，项目记录",
                    content:
                        "虚拟合作商，合作商留言，项目记录虚拟合作商，合作商留言，项目记录虚拟合作商，合作商留言，项目记录虚拟合作商，合作商留言，项目记录虚拟合作商，合作商留言，项目记录虚拟合作商，合作商留言，项目记录"
                },
                {
            ...
            serverList: [
                {
                    ...
                    title: "核心优势1",
                    content: "<p>我们拥有专业的消防安全团队，</p>提供全方位的安全服务。"
                },
                {
